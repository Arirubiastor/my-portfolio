  ...
  <b-container fluid class="p-0">
    <b-row>
      ...
      >
        ...
        <b-card class="embed-instagram__card align-self-center m-auto">
          <!-- <blockquote
            class="instagram-media"
            data-instgrm-captioned
            data-instgrm-permalink="https://www.instagram.com/p/B3Eq_hZoBRu/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          >
            <div style="padding: 16px">
              <a
                href="https://www.instagram.com/p/B3Eq_hZoBRu/?utm_source=ig_embed&amp;utm_campaign=loading"
                style="
                  background: #ffffff;
                  line-height: 0;
                  padding: 0 0;
              ...
              >
                <a
                  ...
                  "
                  target="_blank"
                  >A post shared by A r i a n a R u b í (@ariana.rubii)</a
                >
              </p>
            </div>
          </blockquote> -->
...
// Applies to embeded instagram posts
.embed-instagram__card {   
  .card-body {
  padding: 0;
  }
}
