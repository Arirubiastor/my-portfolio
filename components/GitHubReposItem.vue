      ...
      <a :href="repository.html_url" target="blank">
        ...
        <b-card-text>
          ...
          <div v-if="repository.language">
            ...
            <b-card-text class="d-inline mr-2">
              <svg class="fill-current mr-1" aria-label="stars" viewBox="0 0 16 16" role="img">
                <path fill-rule="evenodd" :d="icon.star"></path>
              </svg>
              {{ repository.stargazers_count }}
            </b-card-text>
            <b-card-text class="d-inline mr-2">
              <svg class="fill-current mr-1" aria-label="fork" viewBox="0 0 16 16" role="img">
